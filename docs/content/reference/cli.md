...
```
usgsquake <command> [arguments] [flags]
```

Run `usgsquake <command> --help` for the full flag list on any command. This
...
per operation you declare in `usgsquake/domain.go`.

...
Most of these come down to network reality or how usgsquake serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

usgsquake rate-limits like any public site. usgsquake already paces
...
Where a surface is gated, usgsquake reads a cookie or token you supply
...
`usgsquake`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what usgsquake actually did

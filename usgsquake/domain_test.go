...
// HTTP behaviour is covered in usgsquake_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "usgsquake" {
		t.Errorf("Identity.Binary = %q, want usgsquake", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "usgsquake://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("usgsquake", "about")
	if err != nil || got.String() != "usgsquake://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want usgsquake://page/about", got.String(), err)
	}
}
